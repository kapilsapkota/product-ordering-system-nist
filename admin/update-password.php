            ...
            <form method="post" action="">
                <table class="table">
                    <tr>
                        ...
                        <td><input type="text" name="old_password" placeholder="Enter your old password.." 
                        id="old_password" class="form-control"></td>
                    </tr>
                    <tr>
                        <td class="text-right">New Password</td>
                        <td><input type="text" name="new_password" placeholder="Enter your new password.." 
                        id="new_password" class="form-control"></td>
                    </tr>

                    <tr>
                        <td class="text-right">Confirm Password</td>
                        <td><input type="text" name="confirm_password" placeholder="Enter your new password.." 
                        id="confirm_password" class="form-control"></td>
                    </tr>
