...
<head>
    ...
    <title>Login - Baje ko Sekuwa</title>
...
<body>
    <div class="login">
        ...
        <br>
        <!-- Form Close -->
        <p class="text-center"> Designed By <a href="">Kapil Sapkota</a> </p>
    </div> 
    <?php
        //Login Code 
    ...
    if(isset($_POST['submit'])){
        ...
        if($res == TRUE){
            ...
            if($count == 1){
                ...
                $_SESSION['message'] = '<div class="error">Your Credentials do not match our records!</div>';
